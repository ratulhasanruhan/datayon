...
/**
 * PNG logo for Google/Search schema + app icons.
 * Kept in `public/` (generated by your favicon tooling).
 */
export const PUBLISHER_LOGO_PNG_PATH = "/web-app-manifest-512x512.png" as const;

export function publisherLogoAbsoluteUrl(): string {
  return `${SITE_URL}${PUBLISHER_LOGO_PATH}`;
}

export function publisherLogoPngAbsoluteUrl(): string {
  return `${SITE_URL}${PUBLISHER_LOGO_PNG_PATH}`;
}
